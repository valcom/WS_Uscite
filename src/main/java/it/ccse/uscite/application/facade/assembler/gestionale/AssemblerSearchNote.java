...
import it.ccse.uscite.application.facade.assembler.util.PageProcessoErogazioneWrapper;
...
public abstract class AssemblerSearchNote {
	...
	public SearchNote_OutDTO assemble(Page<ProcessoErogazione> pageProcessiErogazione){
		return mapToSearchNote_OutDTO(new PageProcessoErogazioneWrapper(pageProcessiErogazione));
	}
	
	protected abstract SearchNote_OutDTO mapToSearchNote_OutDTO(PageProcessoErogazioneWrapper container);
