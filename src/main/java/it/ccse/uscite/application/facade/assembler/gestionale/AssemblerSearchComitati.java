...
import it.ccse.uscite.application.facade.assembler.util.PageOrdineDelGiornoWrapper;
...
public abstract class AssemblerSearchComitati {
	...
	public SearchComitati_OutDTO assemble(Page<OrdineDelGiorno> ordineDelGiornoPage){
		return map(new PageOrdineDelGiornoWrapper(ordineDelGiornoPage));

	}

	protected abstract SearchComitati_OutDTO map(PageOrdineDelGiornoWrapper wrapperPage)  ;
